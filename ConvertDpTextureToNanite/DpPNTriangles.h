...
/**
 * DpFPNTriangles implements curved PN (Point-Normal) Triangles (Curved PN Triangles, Vlachos, 2001).
...
public:
	DpFPNTriangles(FDynamicMesh3* Mesh) : Mesh(Mesh)
	{
	}

	virtual ~DpFPNTriangles() 
	{
	}
