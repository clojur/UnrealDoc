...
namespace AssetUtils
{
	 ...
	 * @return true on success
	 */
	 bool ConvertToSingleChannel(UTexture2D* TextureMap);
	 ...
	 * @return true on success
	 */
	 bool ForceVirtualTexturePrefetch(FImageDimensions ScreenSpaceDimensions, bool bWaitForPrefetchToComplete = true);
