...
namespace UE
{
	namespace MeshDescription
	{
		 ...
		 */
		 void InitializeAutoGeneratedAttributes(FMeshDescription& Mesh, UStaticMesh* StaticMesh, int32 SourceLOD);
		 ...
		 * @param SourceLOD BuildSettings from this LOD Index are used
		 */
		 void InitializeAutoGeneratedAttributes(FMeshDescription& Mesh, UActorComponent* StaticMeshComponent, int32 SourceLOD);
		...
		struct FStaticMeshBuildSettingChange
		{
		...
		/** Utility function to apply build settings changes to a UStaticMesh */
		 void ConfigureBuildSettings(UStaticMesh* StaticMesh, int32 SourceLOD,
